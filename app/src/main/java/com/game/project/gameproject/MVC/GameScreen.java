...
import com.game.project.gameproject.Assets;
import com.game.project.gameproject.LoadingScreen;
import com.game.project.gameproject.MainMenuScreen;
import com.game.project.gameproject.Settings;
...
public class GameScreen extends Screen {
    ...
    private void drawWorld(World world) {
        ...
        Nail[] nails = world.nail;
        Pixmap nailPixmap = Assets.nail;
        ...
        if(((AndroidGame) game).styleType == LoadingScreen.TYPE_CUSTOM){
            for(Nail nail : nails){
                if(nail != null){
                    x = nail.x * 32;
                    y = nail.y * 32;
                    g.drawPixmap(nailPixmap, x, y);
                }
            }
        }
